...
from models.model_trans import MoleculeVAE
from keras.callbacks import ModelCheckpoint, ReduceLROnPlateau

import h5py
import trans_grammar as G
...
def main():
    ...
    # 0. load dataset
    h5f = h5py.File('data/trans_grammar_dataset.h5', 'r')
    data = h5f['data'][:]
    h5f.close()
    ...
    model_save = 'trans_vae_grammar_h' + str(params['hidden']) + '_c234_L' + str(args.latent_dim) + '_E' + str(args.epochs) + '_batchB.hdf5'
    model = MoleculeVAE()
